...
def visualize_forward_diffusion(
    ...
    fig, axes = plt.subplots(num_images, len(timesteps_to_show), figsize=(20, 2.5 * num_images))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="outputs/forward_diffusion.png",
